...
export default function Page() {
  ...
  { "EN": "Aurora Mustika", "CN": "神秘极光上衣" },
  { "EN": "Rosa Lethe", "CN": "绯色忘川上衣" },
  ...
  { "EN": "Millenium Fox (Blue)", "CN": "真天狐巫女" },
  { "EN": "Millenium Fox (Red)", "CN": "天狐巫女" },
  { "EN": "Miracle Alchemist", "CN": "奇迹炼金术师" },
  { "EN": "Nasod Battle Suit MK-B", "CN": "纳斯德战场套装MK-B" },
  { "EN": "Thanatos", "CN": "死神-死亡本能" },
  { "EN": "Hamel Arctic Officer", "CN": "哈梅尔极地上校制服" },
  { "EN": "Royal Blood", "CN": "皇家血裔威严" },
  { "EN": "Hamel Navy Officer", "CN": "哈梅尔海军上校制服" },
  { "EN": "Ignition Caligo", "CN": "烈焰骸龙" },
  { "EN": "Salvatore Ventus", "CN": "风神本图斯" },
  { "EN": "Nasod Battle Suit MK-2", "CN": "纳斯德战场套装MK2" },
  { "EN": "Gold Falcon", "CN": "黄金猎鹰" },
  { "EN": "Glacial", "CN": "冰河" },
  { "EN": "Salvatore Ebalon", "CN": "月神伊贝伦" },
  { "EN": "Pale Shadow", "CN": "暮光恶魔" },
  { "EN": "Dark Shadow", "CN": "暗影恶魔" },
  { "EN": "Holy Unicorn", "CN": "神圣独角兽" },
  { "EN": "Dragon Knight Abbadon", "CN": "龙骑士-堕天使" },
  { "EN": "Dragon Knight Dark Side", "CN": "龙骑士-暗面" },
  { "EN": "Heavenly Diamond Yaksha", "CN": "金刚天夜叉" },
  { "EN": "Diamond Yaksha", "CN": "金刚夜叉" },
  { "EN": "Grace Fairy", "CN": "恩典仙女" },
  { "EN": "Salvatore Ebalon", "CN": "水神特里普" },
  { "EN": "Royal Maid (Black)", "CN": "皇家女仆-暗影弓箭手" },
  { "EN": "Royal Maid (Color)", "CN": "皇家女仆-月夜弓箭手" },
  { "EN": "Velder Imperial Guard", "CN": "皇家禁卫军" },
  { "EN": "Salvatore Solace", "CN": "太阳神索雷斯" },
  { "EN": "Arch Devil", "CN": "弧光恶魔" },
  { "EN": "Nasod Battle Suit", "CN": "纳斯德战场套装" },
  { "EN": "El Search Party Officer", "CN": "艾尔搜查队上校制服" },
  { "EN": "Arch Angel", "CN": "弧光天使" },
  { "EN": "Evil tracer 1-2-3", "CN": "邪魔猎人" }
]
